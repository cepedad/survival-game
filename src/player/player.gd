...
## Constantly check for new instructions to the StateMachine
...
## Translate desired actions from InputHandler into States for the 
## StateMachine.
...
## Signal handler for attack animation ending.
